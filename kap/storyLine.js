    ...
    for(let i = 0; i < storyList.length; i++){
        ...
        if(storyList[i].status){
            storyContaner = 
             ...
             <div class="userinf standartTitle" style="font-size: 14px;position: relative;z-index: 10;margin-top: 14.5px;width: calc(50% - 41px);" id="nameMine">Входящий платеж</div>
            ...
            <div class="userinf standartTitle" style="font-size: 14px;position: relative;z-index: 10;width: calc(50% - 41px);margin-top: 14.5px;" id="nameMine">Исходящий платеж</div>
