...
var itemFullName= ["Угольное сырьё"]
var prices= ["25"]
drawStorage();
...
function showinfo(row){
    console.log(row)
    showItemCard({name:itemFullName[row[0]],count:row[1],price:prices[row[0]]})
